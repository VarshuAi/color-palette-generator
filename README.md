...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/VARSHAN69/color-palette-generator.git
   cd color-palette-generator
   ```
...
[![Repo](https://img.shields.io/badge/color-palette-generator-Repo-00CC66?style=for-the-badge&logo=github&logoColor=black)](https://github.com/VarshuAi/color-palette-generator)
